...
export const metadata = createMetadata({
  title: "About",
  description:
    "Why SnugTalk exists, how listeners are selected and trained, the standards they're held to, and what we do and don't do.",
  path: "/about",
});
          ...
          <Reveal>
            <div className="border-border/70 bg-card relative mx-auto max-w-3xl overflow-hidden rounded-3xl border p-8 sm:p-12">
              ...
              <div className="relative flex flex-col gap-5 text-[1.0625rem] leading-relaxed">
                <p>
                  SnugTalk started with an observation that turned out to be
                ...
                <p className="text-foreground font-medium">
                  Every conversation on SnugTalk is with a real human being. We
