/*
 * PARKED — the full member dashboard, kept for when the wider product returns.
 *
 * This file sits outside the route tree only by name: Next treats
 * `page.full.tsx` as a normal module, not a route, so it ships nothing while
 * staying type-checked and linted.
 *
 * It shows: next session, standing check-in, pending meeting request, session
 * stats, coming-up list, recent notes, subscription usage, saved ideas and
 * favourite listeners.
 *
 * To restore: replace the contents of `page.tsx` with this file's contents, and
 * restore the parked nav items in components/dashboard/member-shell.tsx.
 * See TESTING-SCOPE.md.
 */
...
export default function DashboardPageFull() {
