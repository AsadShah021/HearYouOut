...
export const metadata = createMetadata({
  ...
  description:
    "What HearMeOut collects, what we never do with it, and how to delete everything.",
  path: "/privacy",
});
...
const sections: LegalSection[] = [
  ...
  },
  {
    heading: "Contact",
    paragraphs: [
      "Privacy questions go to privacy@hearmeout.com and are answered by a person, usually within two working days.",
    ],
  },
];
