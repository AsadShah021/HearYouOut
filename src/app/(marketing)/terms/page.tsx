...
export const metadata = createMetadata({
  ...
  description:
    "The agreement between you and HearMeOut, including the important limits of what this service is.",
  path: "/terms",
});

const sections: LegalSection[] = [
  {
    heading: "What HearMeOut is",
    paragraphs: [
      "HearMeOut is a subscription service that connects members with trained human listeners for non-clinical conversations by text, voice, or video.",
      "HearMeOut is not therapy, counseling, psychotherapy, or mental health treatment. Listeners do not diagnose conditions, provide clinical advice, prescribe anything, or deliver any form of medical or psychological care. Nothing said in a session should be treated as professional advice of any kind — medical, legal, financial, or otherwise.",
  ...
  },
  {
    ...
    paragraphs: [
      "Every listener is a member of the HearMeOut in-house team. We do not operate a marketplace, we do not engage freelance or contract listeners, and we are not recruiting — the people named on our team page are the only people who will ever reply to you.",
  ...
  },
  {
    ...
    paragraphs: [
      "To the fullest extent permitted by law, HearMeOut's total liability arising from your use of the service is limited to the amount you paid us in the twelve months preceding the claim.",
  ...
  {
    heading: "Contact",
    paragraphs: ["Questions about these terms go to legal@hearmeout.com."],
  },
];
...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      intro="Section one is the one that matters most: HearMeOut is not therapy. Please read it even if you skip the rest."
      sections={sections}
    />
  );
}
